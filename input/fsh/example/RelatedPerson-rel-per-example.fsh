...
* relationship = http://terminology.hl7.org/CodeSystem/v3-RoleCode#NIECE "niece"
* name.use = #official
* name.text = "陳簡伊"
* name.family = "Chen"
* name.given = "Jian Yi"
...
* address.postalCode.extension.valueCodeableConcept = https://twcore.mohw.gov.tw/ig/twcore/CodeSystem/postal-code3-tw#103
* address.country = "TW"