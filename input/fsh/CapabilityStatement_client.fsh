Instance: CapabilityStatementTWCoreClient
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    ...
    <div class=\"panel panel-default\">
        ...
        <div class=\"panel-body\">
            <div>
                <ul>
                    <li>臺灣核心-用戶端（TW Core Client） <strong>建議應該（SHOULD）</strong>
                    </li>
                    <ol>
                        <li>使用臺灣核心-伺服端（TW Core Server）能力聲明中的查詢參數，支援讀取和查詢一個或多個臺灣核心Profile（s）。</li>
                    </ol>
                    <li>
                        <strong>安全性</strong>
                    </li>
                    <ol>
                        <li>有關要求和建議，請參閱一般安全注意事項部分。</li>
                    </ol>
                    <li>
                    ...
                    <ul>
                        <li>
                            <strong>可能可以（MAY）</strong>支援交易互動（<code>transaction</code> interaction）。
                        </li>
                        <li>
                            <strong>可能可以（MAY）</strong>支援批次互動（<code>batch</code> interaction）。
                        </li>
                        <li>
                            <strong>可能可以（MAY）</strong>支援查詢系統互動（<code>search-system</code> interaction）。
                        </li>
                    </ul>
                </ul>
            </div>
            ...
            <div class=\"container\">
                ...
                <div class=\"row\">
                    <div class=\"col-lg-7\"><span class=\"lead\">能力摘要</span><br />
                        <ul>
                            <li><strong>建議應該（SHOULD）</strong>支援 <code>search-type</code>、 <code>read</code>、 <code>vread</code></li>
                            <li><strong>可能可以（MAY）</strong>支援 <code>create</code>、 <code>update</code>、 <code>delete</code>、<code>patch</code></li>
                        </ul>
                    </div>
                </div>
                <p />
