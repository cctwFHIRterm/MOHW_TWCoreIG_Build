...
* sourceUri = "https://twcore.mohw.gov.tw/ig/twcore/ValueSet/health-department-sta-tw"
* targetUri = "https://twcore.mohw.gov.tw/ig/twcore/ValueSet/health-department-sct-tw"
* group[0].source = "https://twcore.mohw.gov.tw/ig/twcore/CodeSystem/health-department-sta-tw"
...
* group[=].element[=].display = "脊椎骨科"
* group[=].element[=].target.code = #24151000087101
* group[=].element[=].target.display = "Spine orthopedic surgery"
* group[=].element[=].target.equivalence = #equal